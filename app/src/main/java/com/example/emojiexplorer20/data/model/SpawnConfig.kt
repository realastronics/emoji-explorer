...
object SpawnConfig {
    ...
    val SPAWN_POINTS = listOf(
        ...
        EmojiObject("sp_13", 28.1636, 76.7358, "💎", EmojiObject.Rarity.RARE),
        EmojiObject("sp_14", 28.2472, 76.8145, "💎", EmojiObject.Rarity.RARE),
        EmojiObject("sp_14", 28.2472, 76.8143, "💎", EmojiObject.Rarity.RARE)
    )
